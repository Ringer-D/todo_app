    ...
    <ul id="item-list" class="list-group text-white w-96 mr-10">
        <?php
            foreach( $data as $item ) {
                echo '<li id="item-'. $item[ 'id' ] .'" class=" transition ease-in-out delay-150 hover:scale-105 duration-300 p-1 pl-2 mb-1 flex flex-row justify-between items-center border border-white/[.20] rounded">';
                echo    $item[ 'text' ];
